...
namespace FelevesFeladatInfrastructure
{
    ...
    public class Repository:IRepository/*<T> where T : class, IIdEntity*/
    {
        ...
        public void EmployeeUpdate(Employee emp)
        {
            ...
            //empIdUpd.Name = emp.Name;
            //empIdUpd.BirthYear = emp.BirthYear;
            //empIdUpd.StartYear = emp.StartYear;
            //empIdUpd.CompletedProjects = emp.CompletedProjects;
            //empIdUpd.Active = emp.Active;
            //empIdUpd.Retired = emp.Retired;
            //empIdUpd.Email = emp.Email;
            //empIdUpd.Phone = emp.Phone;
            //empIdUpd.Job = emp.Job;
            //empIdUpd.Level = emp.Level;
            //empIdUpd.Salary = emp.Salary;
            //empIdUpd.Commission = emp.Commission;
            //empIdUpd.Departments = emp.Departments;
            ctx.SaveChanges();
        }
